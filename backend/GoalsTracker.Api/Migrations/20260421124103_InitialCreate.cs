        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPublicOnLeaderboard = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AchievementLevels_AchievementLevelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimelineType = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PointTransactions_Goals_GoalId",
                        column: x => x.GoalId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoalTags", x => new { x.GoalId, x.TagId });
                    table.ForeignKey(
                        name: "FK_GoalTags_Goals_GoalId",
                        column: x => x.GoalId,
                        principalTable: "Goals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoalTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AchievementLevels_MinPoints",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AchievementLevelId",
                table: "AspNetUsers",
                column: "AchievementLevelId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TotalPoints",
                table: "AspNetUsers",
                column: "TotalPoints",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Goals_TargetDate_Status",
                table: "Goals",
                columns: new[] { "TargetDate", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Goals_UserId_TimelineType",
                table: "Goals",
                columns: new[] { "UserId", "TimelineType" });

            migrationBuilder.CreateIndex(
                name: "IX_GoalTags_TagId",
                table: "GoalTags",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_PointTransactions_GoalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointTransactions_UserId_TransactionType",
                table: "PointTransactions",
